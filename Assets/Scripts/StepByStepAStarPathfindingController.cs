...
public class StepByStepAStarPathfindingController : PathfindingSystemBase
{
    protected override void Init()
    {
        base.Init();
        m_pathfindingSystem = new AStarPathfindingSystem();
    }
    ...
    protected override void Tick()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (m_pathfindingSystem.IsDone == false)
            {
